...
public class App {
	...
	public static void main(String[] args) {
		...
		Tollfactory fact=new Tollfactory();
		int ch,no,dis;
		...
		while(true) {
			...
			switch(ch) {
			   ...
			   case 2 : 
					    ...
					    break;
			   case 3 : System.out.println("Enter Toll name");
			   			name=in.next();
				        database.getAllTolls(name);
			   			break;
			   case 4 : System.out.println("Enter your vehicle-no");
			   			...
			   			System.out.print("Destination: ");
			   			destination=in.next().charAt(0);
			   			Vehicle vehicle = new Vehicle(number, type, 0.0, userTy);
			   			fact.CalculateFare(database, source, destination, vehicle);
			   			break;
			  case 5 :  System.out.println("Enter Vehicle name");
			   			name=in.next();
				        database.getAllVehicle(name);
			   			break;
